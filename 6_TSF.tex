            ...
            \begin{figure}[H]
                ...
                \subfloat[Spettro di Ampiezza]{
                    \begin{tikzpicture}
                        ...
                        \addplot [red,dotted, samples = 300] {1/(pi*x)*sin(deg(pi*x))};
                        \addplot+ [blue, thick, ycomb, samples at={-2.4,-2.1,-1.8,-1.5,-1.2,-0.9,-0.6,-0.3,0,0.3,0.6,0.9,1.2,1.5,1.8,2.1,2.4}] {abs(1/(pi*x)*sin(deg(pi*x)))};
                        \end{axis}
                    \end{tikzpicture}
                }
                \hfill
                \subfloat[Spettro di Fase]{
                    \begin{tikzpicture}
                        ...
                        \addplot [red,dotted, samples = 300] {1/(pi*x)*sin(deg(pi*x))};
                        \addplot+ [blue, thick, ycomb, samples at={-2.4,-2.1,-1.8,-1.5,-1.2,-0.9,-0.6,-0.3,0,0.3,0.6,0.9,1.2,1.5,1.8,2.1,2.4}] {atan(1/(pi*x)*sin(deg(pi*x)))};
                        \end{axis}
                    \end{tikzpicture}
                }
                \caption{Spettro di una $sinc(x)$}
            \end{figure}
