\section{Trasformata Discreta di Fourier}
    ...
    \subsubsection{Relazione tra $TCF$ e $TDF$}\label{Relazione tra $TCF$ e $TDF$}
        ...
        \end{figure}
    \subsection{Teorema del Campionamento - Nyquist Shannon}
        \begin{figure}[H]
            \centering
                \begin{tikzpicture}[
                        node distance=3cm,
        ...
        \end{figure}
        ho sovrepposizione delle copie di $X_{(f)}$ é il fenomeno di Aliasing: ho sovrapposizione di segnali che alterano il segnale originale. 
        ...
        \begin{itemize}
            ...
            \item {Interpolatore Lineare: incrementa linearmente il valore di $\hat{x}$(é corretto la durata T giusto? il prof ha scritto intervallo -T T)
                \begin{figure}[H]
                    \centering
                    \begin{tikzpicture}
                        \begin{axis}[
