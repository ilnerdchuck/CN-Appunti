\section{Trasformata Continua Di Fourier}
    ...
    \subsection{Equazioni di Analisi e Sintesi}
        ...
        \subsubsection{TCF di una $Arect\left(\frac{t}{T}\right)$}
            ...
            %         \draw[->] (0,-0.5) -- (0,1.5) node[above] {$Arect(\frac{t}{T})$};
            %         \draw[thick] (-1,0) -- (-1,1) -- (1,1) -- (1,0);
            %         \draw[dashed] (-1,-0.1) node[below] {$-\frac{T}{2}$} -- (-1,1) node[pos=1,left] {$A$};
            %         \draw[dashed] (1,-0.1) node[below] {$\frac{T}{2}$} -- (1,1);
            %     \end{tikzpicture}
            % \end{center}
    ...
    \subsection{Modulazione di Ampiezza}\label{Modulazione di Ampiezza}
        ...
        \begin{figure}[H]
            \centering
            \subfloat[Sistema di modulazione]{\includegraphics[width=0.4\textwidth]{media/uwu.png}\label{fig:sistema di modulazione}}
            \hfill
            \subfloat[{\color{blue}$x_{(t)}$}, {\color{red}$y_{(t)}$}]{\includegraphics[width=0.4\textwidth]{media/uwu.png}\label{fig:modulazione in ampiezza}}
            \caption{Esempio sistema di modulazione di ampiezza}
        \end{figure}
        Nel dominio della frequenza:
        \begin{figure}[H]
            \centering
            \subfloat[Senza modulazione]{\includegraphics[width=0.4\textwidth]{media/uwu.png}\label{fig:segnale senza modulazione}}
            \hfill
            \subfloat[Con modulazione]{\includegraphics[width=0.4\textwidth]{media/uwu.png}\label{fig:segnale con modulazione}}
